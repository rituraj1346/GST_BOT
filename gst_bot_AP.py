...
GST_USERNAME = os.getenv("AP_GST_USERNAME")
GST_PASSWORD = os.getenv("AP_GST_PASSWORD")
...
DRIVE_FOLDER_ID = os.getenv("AP_DRIVE_FOLDER_ID")
...
def reconcile_and_upload(gst_file_path, tally_df, period_string, financial_year):
    ...
    gst_cdnr_df['Match_Key'] = gst_cdnr_df['Clean_Name'].astype(str) + "_" + gst_cdnr_df['Clean_Amount'].astype(str)
    ...
    tally_notes['Match_Key'] = tally_notes['Clean_Name'].astype(str) + "_" + tally_notes['Clean_Amount'].astype(str)
